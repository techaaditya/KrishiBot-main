    ...
    return (
        <div className="bg-gray-50 rounded-xl p-4 border border-gray-200 mt-4 flex flex-col h-[300px]">
            ...
            <div className="flex gap-2 mt-auto">
                <input
                    type="text"
                    className="flex-1 border border-gray-300 rounded-full px-3 py-2 text-sm focus:ring-2 focus:ring-green-500 outline-none"
                ...
                <button
                    ...
                    className="bg-[#059669] text-white p-2 rounded-full hover:bg-[#047857] disabled:opacity-50"
                >
