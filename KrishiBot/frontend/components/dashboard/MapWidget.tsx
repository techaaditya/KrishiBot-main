...
const MapWidget: React.FC<MapWidgetProps> = ({ mode, initialLat, initialLng, onLocationSelect }) => {
    ...
    useEffect(() => {
        ...
        // Timeout fallback after 5 seconds to stop polling (though it will remain loading=true)
        const timeout = setTimeout(() => clearInterval(checkLeaflet), 5000);
