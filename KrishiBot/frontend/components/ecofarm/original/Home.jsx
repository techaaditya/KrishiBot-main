...
const markerIcon2x = '/game_assets/leaflet/marker-icon-2x.png';
const markerIcon = '/game_assets/leaflet/marker-icon.png';
const markerShadow = '/game_assets/leaflet/marker-shadow.png';
